...
class BaseConfig(object):
    UPLOAD_FOLDER = '/Users/rudykabimbingoy/Documents/DEVELOPEMENT/_MEMOIRE/eVscape_flask/eVscape_flask/uploader_folder'
    MAX_CONTENT_LENGTH = 16 * 1024 * 1024
    SECRET_KEY = binascii.hexlify(os.urandom(24))  
    DEBUG=True
    ENV="development"
    SQLALCHEMY_DATABASE_URI = 'sqlite:///'+os.path.join(basedir,'db','eVscape.db')#basedir pour dire on part du truc de base et ensuite il trouvera le fichier db qui s'appelle enigmes.db dans le dossier "db"
